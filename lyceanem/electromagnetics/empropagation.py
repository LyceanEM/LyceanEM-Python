...
def freqdomainkernal(
    ...
    if cu_ray_num < network_index.shape[0]:
        ...
        print("hi from thread", cu_ray_num)


        if source_sink_index[cu_ray_num, 0] == 0 & source_sink_index[cu_ray_num, 1] == 36:
            print( "efield via scatter", network_index[cu_ray_num, 1], (float)(ray_component[0].real), (float)(ray_component[1].real), (float)(ray_component[2].real))
